...
parser.add_argument('--BATCHSIZE', dest='BATCHSIZE',type=int, default=100, help='Batch size')
parser.add_argument('--learning_rate', dest='learning_rate', default=0.001, type=float, help='Learning_rate of Adam')
parser.add_argument('--dropout_late', dest='dropout_late', default=0.1, type=float, help='dropout rate')
parser.add_argument('--recurrent_dropout_late', dest='recurrent_dropout_late', type=float, default=0.15, help='Recurrent dropout rate')
parser.add_argument('--SEQLEN', dest='SEQLEN', default=20-1, help='maximum number of actions in a session')
parser.add_argument('--GRU_hidden', dest='GRU_hidden',type=int, default= 100, help='GRU hidden layers')
parser.add_argument('--EMBEDDING_SIZE', dest='EMBEDDING_SIZE', type=int, default= 100, help='EMBEDDING dimension')
parser.add_argument('--TOP_K', dest='TOP_K', default=20, type=int, help='Evaluation TopK')
parser.add_argument('--MAX_EPOCHS', dest='MAX_EPOCHS', type=int, default=20, help='Maximum epoch'
